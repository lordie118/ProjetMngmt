...
<body class="antialiased">
    ...
    <body>
            ...
            <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
                <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    <a href="#" class="flex items-center">
                        ...
                        <span
                            class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">SGP</span>
                    </a>
                            ...
                            <defs>
                                <clipPath id="clip0_3753_27919">
                                    <rect width="150" height="32.8125" fill="white"
                                        transform="translate(0.0820312 0.835449)"></rect>
                                </clipPath>
                            </defs>
                        </svg>
                    </a>
        ...
        <section class="bg-gray-50 dark:bg-gray-800">
            <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
                <figure class="max-w-screen-md mx-auto">
                    ...
                    <blockquote>
                        <p class="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">"  Création de produits numériques et de marques : un système de gestion de projet optimisé pour l'innovation et la croissance"</p>
                    </blockquote>
        ...
        <footer class="bg-white dark:bg-gray-800">
            <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="text-center">
                    ...
                    <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 SGP. All
        ...
        <script defer=""
            ...
            data-cf-beacon="{&quot;rayId&quot;:&quot;88e8c2616f073972&quot;,&quot;r&quot;:1,&quot;version&quot;:&quot;2024.4.1&quot;,&quot;token&quot;:&quot;3a2c60bab7654724a0f7e5946db4ea5a&quot;}"
